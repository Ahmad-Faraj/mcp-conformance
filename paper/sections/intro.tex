...
them. Separately, \SilentExecRate{} of responding servers execute a tool on an
argument their own declared schema rejects and return a well-formed result: a
code-scanning tool asked to scan an integer replied \texttt{CLEAN}. No error code, no
\texttt{isError} flag, nothing a client could act on. A further \MalformedDiesRate{}
die on a malformed frame, which is a denial-of-service primitive.
