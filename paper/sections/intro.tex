...
can lose more than a capability: it can act on wrong output with full confidence. The reliability of this server layer is therefore a reliability
...
change aligns the specification with practice~\cite{sep2145}. Our census measures how far practice has already moved. Separately, \SilentExecRate{} of responding servers execute a tool on
...
\begin{itemize}
  \item \textbf{A protocol-level conformance measurement of the MCP ecosystem by
    ...
    and speak the protocol to a complete census of the eligible registry, testing how each server responds to inputs, and releasing an
