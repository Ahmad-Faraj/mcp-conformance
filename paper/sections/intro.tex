...
Yet we know remarkably little about how these servers actually behave, because the
...
We close that gap. We present an execution-based conformance study of the
...
inputs. A further \MalformedDiesRate{} fail to recover from a malformed frame,
answering nothing further on a channel that the specification requires them to keep
serving.
