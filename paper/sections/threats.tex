...
percentage points. We report the full-census figures as our primary result, because the census is the object of study, and the
...
is a robustness and conformance failure, which is how we now report it, and we record the correction here. The same maintainer traced the
