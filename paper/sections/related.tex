...
The two peer-reviewed studies of this ecosystem are both static. One analyzes source
and metadata for roughly 1,900 GitHub-sourced servers with static scanners and
code-smell detectors~\cite{mcpfirstglance}; the other surveys the protocol's
landscape and security threats~\cite{mcplandscape}. Ours differs on both axes: the
population comes from the official registry a client resolves against, and every
server is executed. Elsewhere,
