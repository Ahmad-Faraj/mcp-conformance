...
the SDKs already do~\cite{sep2145}. Our census shows how far that behaviour has
...
are the minority that follow the current text. That is worth knowing before the
proposal is decided.
...
third-party wrappers. A bad default spreads this way, and so would a fix: changing a
few SDKs would change most of the population. For monitoring conformance, the SDKs
