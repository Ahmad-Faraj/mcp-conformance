...
version the server \emph{negotiates}, and grades all subsequent checks against that
negotiated version rather than the latest specification. A server that supports the
offered version must answer with it, and \(3{,}576\) of \Nresponders{} responders did,
so almost all grading is against \texttt{2025-06-18}. This is not a formality. Responding servers negotiated four distinct
