...
complete census of the eligible population rather than a sample.
...
rather than a failure, and quantify its prevalence as a first-class result, since it
is the clearest instance of specification text diverging from universal practice.
...
independently. For the input-validation result we settle this with a direct test
rather than inference. We build two minimal servers exposing one tool that declares a
