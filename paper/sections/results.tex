...
the npm servers in our census. The two differ in snapshot and harness, so we
do not read the gap as a trend. Because we census the entire eligible frame, our
figures are population counts, not estimates.
...
ecosystem's existing behaviour, not changing it. The other \NotErrAsResultPct{} are
